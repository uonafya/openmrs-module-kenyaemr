...
/**
 * Evaluates OPD Oxygen Saturation 
 * OPD Register
 */
@Handler(supports= OPDOxygenSaturationDataDefinition.class, order=50)
public class OPDOxygenSaturationDataEvaluator implements EncounterDataEvaluator {
