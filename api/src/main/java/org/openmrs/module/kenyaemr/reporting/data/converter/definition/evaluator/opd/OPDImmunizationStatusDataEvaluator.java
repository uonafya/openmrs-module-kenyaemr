...
import org.openmrs.module.kenyaemr.reporting.data.converter.definition.opd.OPDImmunizationStatusDataDefinition;
...
/**
 * Evaluates Immunization status prescribed 
 * OPD Register
 */
@Handler(supports= OPDImmunizationStatusDataDefinition.class, order=50)
public class OPDImmunizationStatusDataEvaluator implements EncounterDataEvaluator {
