...
/**
 * Evaluates OPD Respiratory Rate 
 * OPD Register
 */
@Handler(supports= OPDRespiratoryRateDataDefinition.class, order=50)
public class OPDRespiratoryRateDataEvaluator implements EncounterDataEvaluator {
