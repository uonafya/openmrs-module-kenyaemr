...
import org.openmrs.module.kenyaemr.reporting.data.converter.definition.opd.OPDPulseRateDataDefinition;
...
/**
 * Evaluates Pulse Rate Saturation 
 * OPD Register
 */
@Handler(supports= OPDPulseRateDataDefinition.class, order=50)
public class OPDPulseRateDataEvaluator implements EncounterDataEvaluator {
