...
/**
 * Evaluates OPD Temperature
 * OPD Register
 */
@Handler(supports= OPDTemperatureDataDefinition.class, order=50)
public class OPDTemperatureDataEvaluator implements EncounterDataEvaluator {
