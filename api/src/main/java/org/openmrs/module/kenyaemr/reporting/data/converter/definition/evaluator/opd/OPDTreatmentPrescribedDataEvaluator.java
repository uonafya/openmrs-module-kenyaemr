...
/**
 * Evaluates treatment prescribed 
 * OPD Register
 */
@Handler(supports= OPDTreatmentPrescribedDataDefinition.class, order=50)
public class OPDTreatmentPrescribedDataEvaluator implements EncounterDataEvaluator {
